...
public class BudgetTestMapfra implements Runnable, Testable {
	private String browser;
	private HashMap<String, String> parameters;
	
	public BudgetTestMapfra(String b, HashMap<String, String> p){
		this.browser = b;
		this.parameters = p;
	}
...
//			prox.click();
	...
	public void fillField(WebElement element, String key, WebDriver driver){
		try{
			...
			actions.click();
	//		actions.sendKeys(this.parameters.get(key)).perform();
